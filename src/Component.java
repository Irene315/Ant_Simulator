 ...
 * 
 * Description: 
 *  1. Modified function update according to pseudocode given in lab to render the ant object.
 *  
 *  2. Modified color to white
 *  
 */
...
public class Component implements Rotatable, Nameable, UpdatingDisplayable, Colorable {
	...
	public void update(final GL2 gl) {
		...
		// retrieve all children data to current component
		for (final Component child : this.children) {
			child.draw(gl);
		}
